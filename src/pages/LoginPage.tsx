...
const LoginPage = () => {
  ...
  useEffect(() => {
    document.title = 'Christian Library - Login';
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-200">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <p className="text-xs text-gray-500 mb-1">Regular User:</p>
                <p className="text-xs text-gray-800">user@example.com</p>
                <p className="text-xs text-gray-800">user123</p>
              </div>
              <div>
                <p className="text-xs text-gray-500 mb-1">Admin User:</p>
                <p className="text-xs text-gray-800">admin@example.com</p>
                <p className="text-xs text-gray-800">admin123</p>
              </div>
            </div>
          </div>
        </div>
